...
import com.lay.betterbadges.emblem.EmblemSlot;
...
import com.lay.betterbadges.item.bounded.BoundItemWrapper;
...
public class BadgeCaseScreenHandler extends AbstractItemContainerMenu {
    ...
    public void switchLeague(League league){
        ...
        List<com.lay.betterbadges.league.BadgeSlot> badgeSlots = league.getBadges();
        ...
        for (int i = 0; i < 8; i++){
            ...
            if(slot.container == this.currentContainer) {
                com.lay.betterbadges.league.BadgeSlot badgeSlot = badgeSlots.removeFirst();
    ...
    private void createLeagueBadgesSlots() {
        for (com.lay.betterbadges.league.BadgeSlot badgeSlot : this.badgeCase.getCurrentLeague().getBadges()){
